...
public class Main{
    ...
    public static void main(String[] args) {
        ...
        for(int i = potPosition;i<=potPosition+GENERATIONS*3;i++){
            plantPots.add(new PlantPot(i,false));
        }
        int value = 0;
        int difference = 0;
        ...
        System.out.println("Amount of generations to go: "+(50000000000L-GENERATIONS));
        System.out.println("Difference: "+difference);
        System.out.println("Amount of generations to go*differences: "+(50000000000L-GENERATIONS)*difference);
        System.out.println("Summe: "+getSum());
        System.out.println("Total Summe after 50'000'000'000: "+((50000000000L-GENERATIONS)*difference+getSum()));
    }
